...
<div>
            ...
            {/*Card*/}
            <a href="#" className="w-72 bg-slate-900 border rounded-lg border-gray-700 p-5 shadow hover:bg-gray-700 delay-100 duration-200">

            {/*Header*/} 
                <div className="flex flex-row">
                    <img src={Profile} className="w-10 h-10	rounded" />
                    <p className="ml-3">
